                         ...
                         <div className="space-y-2 text-end">
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className={`w-full bg-[#F5F8F7] border ${errors.email ? 'border-red-500' : 'border-transparent focus:border-[#00695C]'} text-slate-800 rounded-xl py-3.5 pe-11 ps-4 outline-none transition-all placeholder-slate-400 text-start dir-ltr`}
                                    dir="ltr"
                                />
                            </div>
                         ...
                         <div className="space-y-2 text-end">
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className={`w-full bg-[#F5F8F7] border ${errors.phone ? 'border-red-500' : 'border-transparent focus:border-[#00695C]'} text-slate-800 rounded-xl py-3.5 pe-11 ps-4 outline-none transition-all placeholder-slate-400 text-start dir-ltr`}
                                    dir="ltr"
                                />
                            </div>
