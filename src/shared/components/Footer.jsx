                    ...
                    <div className="space-y-4">
                        ...
                        <ul className="space-y-3">
                            <li className="flex items-center gap-2">
                                ...
                                <a href={`mailto:${email}`} dir="ltr" className="hover:text-[#00695C] transition-colors">{email}</a>
                            </li>
                            <li className="flex items-center gap-2">
                                <Phone className="w-5 h-5 text-[#735C00]" />
                                <a href={`tel:${phone}`} dir="ltr" className="hover:text-[#00695C] transition-colors">{phone}</a>
                            </li>
                            <li className="flex items-center gap-2">
                                ...
                                <a href={`https://wa.me/${whatsapp.replace(/[^0-9]/g, '')}`} target="_blank" rel="noopener noreferrer" dir="ltr" className="hover:text-[#00695C] transition-colors">{whatsapp}</a>
                            </li>
                        </ul>
                    </div>
                </div>
