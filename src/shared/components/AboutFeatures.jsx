        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            ...
            <div className="text-center mb-16">
                <h2 className="text-3xl sm:text-4xl font-extrabold text-[#111827] inline-block relative">
                    ...
                    <span className="absolute -bottom-4 start-1/2 -translate-x-1/2 w-24 h-1 bg-[#735C00] rounded-full"></span>
                </h2>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8">
                ...
                >
                    ...
                    <div className="w-full sm:w-5/12 aspect-[4/3] sm:aspect-square lg:aspect-[4/3] rounded-2xl overflow-hidden shrink-0">
                        <img 
                            src={imagesrc} 
                            alt="Students" 
                ...
                <motion.div 
                    ...
                    className="lg:col-span-4 bg-[#FECD31] rounded-[2rem] p-8 flex flex-col justify-center items-center sm:items-start space-y-6 shadow-sm"
                >
                ...
                {/* Row 2 (Reversed Grid Order) */}
                <motion.div
                    initial={{ opacity: 0, y: 20 }}
                    whileInView={{ opacity: 1, y: 0 }}
                    viewport={{ once: true }}
                    transition={{ duration: 0.4, delay: 0.1 }}
                    className="lg:col-span-4 bg-[#00695C] rounded-[2rem] p-8 flex flex-col justify-center items-center sm:items-start space-y-6 shadow-sm"
                >
                ...
                <motion.div 
                    ...
                    viewport={{ once: true }}
                    transition={{ duration: 0.4 }}
                    className="lg:col-span-8 bg-white rounded-[2rem] p-6 sm:p-8 flex flex-col sm:flex-row-reverse items-center gap-8 shadow-sm border border-slate-100/50"
                >
                    <div className="flex-1 space-y-4 text-center sm:text-start">
                        <h3 className="text-2xl font-bold text-[#00695C]">
