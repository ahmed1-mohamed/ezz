      ...
      <header className="lg:hidden w-full bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 h-16 px-4 sm:px-6 flex items-center justify-between sticky top-0 z-30 shrink-0">
        <div className="flex items-center gap-3">
          ...
          <div className="text-start hidden sm:block">
            <h2 className="text-[#0f7a6c] dark:text-emerald-400 font-bold text-sm leading-tight">{t('studentDashboard.header.title')}</h2>
          </div>
        </div>

        <Link to="/dashboard/student/settings" className="flex items-center gap-2.5 p-1 hover:bg-slate-50 dark:hover:bg-slate-800/60 rounded-xl transition-colors">
          <div className="text-end">
            ...
            <p className="text-[9px] text-slate-400 dark:text-slate-500 font-medium">
              {t('studentDashboard.user.role', 'طالب')}
            </p>
          </div>
