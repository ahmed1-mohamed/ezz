    ...
    return (
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            <motion.div
                ...
                viewport={{ once: true }}
                className="w-full bg-white rounded-3xl p-6 sm:p-8 shadow-sm border border-slate-100"
            >
                ...
                <div className="space-y-4">
                    {schedule.map((item, index) => (
                        <div key={index} className="flex flex-col sm:flex-row items-center justify-between border border-slate-100 rounded-2xl p-4 sm:p-6 gap-6 hover:shadow-md transition-shadow">
                            ...
                            {/* Middle details */}
                            <div className="order-2 flex-1 text-center sm:text-right space-y-2 w-full">
